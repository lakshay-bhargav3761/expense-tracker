export const dashboardStyles = {
  ...
  headerSubtitle: "text-gray-600 dark:text-gray-300 mt-2",
  ...
  timeFrameWrapper: "flex gap-0 bg-white dark:bg-gray-800 dark:bg-gray-800 p-1 -mx-5 rounded-xl border border-gray-200 dark:border-gray-600",
  ...
  gaugeGrid: "grid grid-cols-1 -mx-5 xl:-mx-5 md:grid-cols-3 md:gap-12 lg:gap-3 lg:grid-cols-2 xl:grid-cols-3 gap-6 mb-8",
  
  // Pie chart container styles
  pieChartContainer: "hidden md:block bg-white dark:bg-gray-800 dark:bg-gray-800 lg:-mx-5-5 md:-mx-4 lg:p-1 xl:-mx-3 rounded-xl p-5 shadow-sm border border-gray-100 dark:border-gray-700 relative overflow-hidden mb-8",
  pieChartHeader: "flex flex-col sm:flex-row justify-between items-start sm:items-center mb-5 gap-3",
  pieChartTitle: "text-xl lg:pt-3 xl:pl-3 font-bold text-gray-800 dark:text-white mb-5 flex items-center gap-3",
  ...
  legendText: "text-sm font-medium text-gray-600 dark:text-gray-300",
  
  // Income/Expense lists grid
  listsGrid: "grid grid-cols-1 gap-6",
  
  // List container styles
 listContainer: "bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-2xl lg:p-5 md:p-6 -mx-8 md:-mx-3 shadow-sm border border-gray-100 dark:border-gray-700",
  listHeader: "flex flex-col sm:flex-row justify-between items-start sm:items-center mb-5 gap-3",
  listTitle: "text-xl font-bold text-gray-800 dark:text-white md:mt-3 mt-3 flex items-center gap-3",
  ...
  emptyText: "text-gray-600 dark:text-gray-300 font-medium",
  
  // View all button styles
  viewAllContainer: "pt-4 border-t border-gray-100 dark:border-gray-700",
...
// FIX: Swapped positive/negative colors — positive trend should be green, negative should be red
...
export const incomeStyles = {
  ...
  headerContainer: "bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-lg md:rounded-xl p-4 -mx-7 lg:-mx-7 overflow-x-hidden md:p-6 mb-6 md:mb-8 shadow",
  header: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 md:gap-4 mb-4 md:mb-6",
  headerTitle: "text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 dark:text-white",
  headerSubtitle: "text-gray-600 dark:text-gray-300 mt-1 text-sm md:text-base",
  ...
  // Chart
  chartContainer: "hidden md:block -mx-7 bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700",
  chartTitle: "text-lg md:text-xl font-bold text-gray-800 dark:text-white mb-4 md:mb-5 flex items-center gap-2 md:gap-3",
  
  // Transaction List
  listContainer: "bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl -mx-7 md:rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100 dark:border-gray-700 relative overflow-hidden",
  sectionTitle: "text-lg md:text-xl font-bold text-gray-800 dark:text-white mb-4 md:mb-5 flex items-center gap-2 md:gap-3",
  
  // Filter Section
  filterContainer: "flex flex-col sm:flex-row gap-2 md:gap-3 w-full sm:w-auto",
  filterSelect: "appearance-none bg-white dark:bg-gray-800 dark:bg-gray-800 text-black dark:text-white border border-gray-300 dark:border-gray-600 rounded-lg pl-3 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent w-full",
  exportButton: "flex items-center justify-center gap-1 bg-white dark:bg-gray-800 dark:bg-gray-800 text-black dark:text-white border border-gray-300 dark:border-gray-600 hover:bg-gray-50 px-3 py-2 rounded-lg transition-all text-sm hover:shadow-md w-full sm:w-auto",
  ...
  emptyStateText: "text-gray-600 dark:text-gray-300 font-medium text-sm md:text-base",
...
export const expensePageStyles = {
  ...
  // Header card
  headerCard: "bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl p-4  lg:-mx-0 -mx-3.5  overflow-x-hidden mb-8 shadow",
  headerContainer: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 md:gap-4 mb-4 md:mb-6",
  headerTitle: "text-2xl md:text-3xl font-bold text-gray-800 dark:text-white dark:text-white",
  headerSubtitle: "text-gray-600 dark:text-gray-300 mt-1",
  ...
  // Chart container
  chartContainer: "hidden md:block bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl p-4 -mx-7 lg:-mx-0 shadow-sm border border-gray-100 dark:border-gray-700",
  chartHeader: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-5",
  chartTitle: "text-xl font-bold text-gray-800 dark:text-white dark:text-white mb-5 flex items-center gap-3",
  exportButton: "flex items-center gap-1 bg-white dark:bg-gray-800 dark:bg-gray-800 text-black dark:text-white border border-gray-300 dark:border-gray-600 hover:bg-gray-50 text-gray-700 px-4 py-2 rounded-lg transition-all text-sm hover:shadow-md",
  chart: "h-80",
  
  // Transactions container
  transactionsContainer: "bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-2xl p-5 -mx-4 lg:-mx-0 md:-mx-5 shadow-sm border border-gray-100 dark:border-gray-700 relative overflow-hidden",
  transactionsHeader: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 md:gap-4 mb-4 md:mb-5",
  transactionsTitle: "text-lg md:text-xl font-bold text-gray-800 dark:text-white dark:text-white mb-4 md:mb-5 flex items-center gap-2 md:gap-3",
  filterSelect: "appearance-none bg-white dark:bg-gray-800 dark:bg-gray-800 text-black dark:text-white border border-gray-300 dark:border-gray-600 rounded-lg pl-3 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent w-full",
  ...
  emptyStateText: "text-gray-600 dark:text-gray-300 font-medium",
 ...
 chartExportButton: "flex items-center gap-1 bg-white dark:bg-gray-800 dark:bg-gray-800 text-black dark:text-white border border-gray-300 dark:border-gray-600 hover:bg-gray-50 px-4 py-2 rounded-lg transition-all text-sm hover:shadow-md",
  ...
  transactionItemContainer: "flex items-center justify-between p-3 -mx-2 hover:bg-amber-50 rounded-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 cursor-pointer mb-3 group",
...
export const profileStyles = {
 ...
 mainContainer: "bg-white dark:bg-gray-800 dark:bg-gray-800 -mx-7 rounded-2xl shadow-sm overflow-hidden",
  
  // Header styles
  header: "bg-gradient-to-r from-teal-500 to-emerald-600 p-8 text-center",
  avatar: "w-24 h-24 mx-auto rounded-full bg-white dark:bg-gray-800/20 flex items-center justify-center mb-4",
  ...
  // Card styles
  card: "bg-gray-50 dark:bg-gray-700 rounded-xl p-6",
  cardTitle: "text-xl font-semibold pb-3 text-gray-800 dark:text-white dark:text-white flex items-center",
  icon: "w-5 h-5 mr-2 text-teal-600",
  
  // Form styles
  label: "text-sm text-gray-500  block mb-1",
  input: "w-full px-4 py-2 bg-white dark:bg-gray-800 dark:bg-gray-800 text-black dark:text-white border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-teal-300 focus:border-teal-500",
  ...
  buttonSecondary:
"flex-1 py-2.5 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 rounded-xl font-medium hover:bg-gray-100 dark:hover:bg-gray-700",
  ...
  // Security item
  securityItem: "flex items-center justify-between p-4 bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl border border-gray-200",
  securityText: "font-medium lg:text-sm text-gray-400",
  
  // Modal styles
  modalContent: "bg-white dark:bg-gray-800 rounded-2xl p-6 lg:px-28 w-full max-w-md",
  modalHeader: "flex justify-between lg:whitespace-nowrap lg:space-x-20 mb-6",
  modalTitle: "text-xl font-bold lg:pl-10 text-gray-800 dark:text-white dark:text-white",
...
export const modalStyles = {
  ...
  modalContainer: "bg-white dark:bg-gray-800 dark:bg-gray-800 text-black dark:text-white rounded-2xl p-6 max-w-md w-full shadow-2xl",
  
  // Header
  modalHeader: "flex justify-between items-center mb-4",
  modalTitle: "text-xl font-bold text-gray-800 dark:text-white dark:text-white",
  closeButton: "text-gray-500 hover:text-gray-800 dark:text-white dark:text-white",
  ...
  typeButton: (isSelected, color) => 
    `flex-1 py-2 rounded-lg font-medium ${
      isSelected 
        ...
        : 'bg-gray-100 text-gray-800 dark:text-white dark:text-white hover:bg-gray-200'
    }`,
...
export const loginStyles = {
  // Page container
 pageContainer: "min-h-screen flex items-center justify-center p-4 bg-[url('/bg.jpg')] bg-cover bg-center",
  
  // Card container
  cardContainer: "w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden",
  
  // Header styles
  header: "bg-gradient-to-r from-teal-500 to-emerald-600 p-6 text-center",
  avatar: "w-20 h-20 mx-auto rounded-full bg-white dark:bg-gray-800/20 flex items-center justify-center mb-4",
  ...
  signUpText: "text-gray-600 dark:text-gray-300",
...
export const navbarStyles = {
  ...
  header: "sticky top-0 z-50 bg-white dark:bg-gray-800 dark:bg-gray-900 border-b border-gray-100 dark:border-gray-700 shadow-sm",
  ...
  userName: "text-sm font-medium text-gray-800 dark:text-white dark:text-white truncate max-w-[120px]",
  ...
  dropdownMenu: "absolute top-14 right-0 w-56 bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 z-50",
  dropdownHeader: "px-4 py-3 border-b border-gray-100 dark:border-gray-700",
  ...
  dropdownName: "text-sm text-gray-800 dark:text-white dark:text-white",
  ...
  menuItemBorder: "p-1.5 border-t border-gray-100 dark:border-gray-700",
...
export const signupStyles = {
  ...
  headerTitle: "text-2xl font-bold text-white",
  headerSubtitle: "text-teal-100 mt-2",
  backButton: "absolute top-4 left-4 p-2 text-white rounded-full hover:bg-white dark:bg-gray-800/10 transition-colors",
  ...
  signInText: "text-gray-600 dark:text-gray-300",
...
export const transactionItemStyles = {
  ...
  container: (isEditing, classes) => 
    `flex flex-col md:flex-row items-stretch justify-between gap-3 p-4 rounded-xl border border-gray-100 dark:border-gray-700 mb-3 last:mb-0 ${isEditing ? classes.bg : "hover:bg-gray-50"}`,
  ...
  description: "font-medium text-gray-800 dark:text-white dark:text-white truncate",
  details: "text-xs text-gray-500 mt-1 truncate",
  
  // Input styles
  input: (hasError, classes) => 
    `w-full bg-white dark:bg-gray-800 rounded-lg px-3 py-2 focus:outline-none focus:ring-1 ${hasError ? "border-red-500 ring-red-500" : `${classes.border} ${classes.ring}`}`,
  amountInput: (hasError, classes) => 
    `w-full max-w-[120px] bg-white dark:bg-gray-800 rounded-lg px-3 py-2 focus:outline-none focus:ring-1 ${hasError ? "border-red-500 ring-red-500" : `${classes.border} ${classes.ring}`}`,
...
export const sidebarStyles = {
  ...
  sidebarInner: {
  base: "bg-white dark:bg-gray-800 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 shadow-md h-full flex flex-col"
  },
  
  // User profile section
  userProfileContainer: {
    base: "p-4 border-b pt-20 md:pt-5 lg:pt-5 xl:pt-5 border-gray-100 dark:border-gray-700",
    collapsed: "px-3",
    expanded: "px-6"
  },
  ...
  menuItem: {
    ...
    inactive: "text-gray-600 dark:text-gray-300 hover:text-teal-700 hover:bg-gray-50",
  ...
  // Toggle button
  toggleButton: {
    base: "absolute -right-3 top-12 z-20 w-6 h-6 bg-white dark:bg-gray-800 dark:bg-gray-800 text-black dark:text-white border border-gray-300 dark:border-gray-600 rounded-full flex items-center justify-center text-gray-500 hover:text-teal-600 hover:border-teal-400 hover:bg-teal-50 transition-all"
  },
  
  // Footer section
  footerContainer: {
    base: "border-t border-gray-100 dark:border-gray-700 p-4",
    collapsed: "px-3",
    expanded: "px-6"
  },
  
  footerLink: {
    base: "flex items-center gap-3 py-2 rounded-xl font-medium text-gray-600 dark:text-gray-300 hover:text-teal-700 hover:bg-gray-50",
    collapsed: "justify-center"
  },
  
  logoutButton: {
    base: "flex items-center gap-3 py-2 rounded-xl font-medium text-gray-600 dark:text-gray-300 hover:text-red-600 hover:bg-red-50 w-full mt-1",
    collapsed: "justify-center"
  },
  ...
  mobileSidebar: {
  base: "absolute left-0 top-0 bottom-0 w-4/5 max-w-sm bg-white dark:bg-gray-800 dark:bg-gray-900 shadow-2xl rounded-r-2xl overflow-hidden"
  },
  
  mobileHeader: "p-6 flex justify-between items-center border-b border-gray-100 dark:border-gray-700",
  ...
  mobileMenuItem: {
    ...
    active: "text-teal-600 bg-teal-50",
    inactive: "text-gray-600 dark:text-gray-300 hover:bg-gray-50"
  },
  
  mobileFooter: "border-t border-gray-100 dark:border-gray-700 p-6",
  mobileFooterLink: "flex items-center gap-4 py-2 font-medium text-gray-600 dark:text-gray-300 hover:text-teal-700",
  mobileLogoutButton: "flex items-center gap-4 py-2 font-medium text-gray-600 dark:text-gray-300 hover:text-red-600 w-full",
...
export const styles = {
  ...
  statCards: {
    ...
    card: "bg-white dark:bg-gray-800 p-5 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700",
    cardHeader: "flex justify-between items-start",
    cardTitle: "text-sm text-gray-600 dark:text-gray-300",
    cardValue: "text-2xl font-bold text-gray-800 dark:text-white dark:text-white mt-1",
  ...
  // Card Styles
  cards: {
    base: "bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700",
    header: "flex justify-between items-center mb-6",
    title: "text-xl font-bold text-gray-800 dark:text-white dark:text-white flex items-center gap-3",
    titleIcon: "w-6 h-6",
  },
  ...
  transactions: {
    ...
    cardTitle: "text-md md:text-xl lg:text-xl xl:text-xl font-bold text-gray-800 dark:text-white dark:text-white flex items-center gap-3",
    ...
    transactionItem: "flex items-center lg:flex-col xl:flex-row md:flex-row justify-between p-1 -mx-0 lg:p-4 md:p-4 hover:bg-gray-50 rounded-xl transition-all duration-300 border border-gray-100 dark:border-gray-700",
    iconWrapper: (type) => type === 'income' ? 'bg-teal-100 text-teal-600' : 'bg-orange-100 text-orange-600',
    icon: "w-4 h-4",
    details: "min-w-0",
    description: "font-medium text-gray-800 dark:text-white dark:text-white truncate max-w-[120px]",
  ...
  categories: {
    title: "text-lg md:text-xl lg:text-xl xl:text-xl font-bold text-gray-800 dark:text-white dark:text-white mb-6 flex items-center gap-3",
    ...
    categoryIcon: "w-4 h-4 text-gray-600 dark:text-gray-300",
    categoryName: "font-medium text-gray-700",
    categoryAmount: "font-semibold text-gray-800 dark:text-white dark:text-white",
    summaryContainer: "mt-6 pt-6 border-t border-gray-100 dark:border-gray-700",
    ...
    summaryTitle: "text-sm text-gray-600 dark:text-gray-300",
    summaryValue: "text-sm font-bold text-gray-800 dark:text-white dark:text-white",
  },
