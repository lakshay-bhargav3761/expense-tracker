      ...
      <div className="w-full h-48">
        <ResponsiveContainer>
          ...
          >
            ...
            {/* FIX: SVG text doesn't support Tailwind className — use inline style */}
            <text 
              x="50%" 
              y="50%" 
              textAnchor="middle" 
              dominantBaseline="middle"
              style={{ fontSize: '1.25rem', fontWeight: 'bold', fill: isNegative ? '#dc2626' : (colorInfo.gradientStart || '#1f2937') }}
            >
            ...
            <text 
              ...
              textAnchor="middle" 
              dominantBaseline="middle"
              style={{ fontSize: '0.875rem', fill: isNegative ? '#ef4444' : '#6b7280' }}
            >
